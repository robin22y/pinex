    ...
    return (
      <>
        ...
        <div style={{ minHeight: '100vh', background: '#0B0E11', display: 'flex', flexDirection: 'column' }}>
          <div style={{ flexShrink: 0, display: 'flex', alignItems: 'center', gap: 12, padding: '12px 16px', borderBottom: '1px solid #1E2530', background: '#0F1217' }}>
            <button type="button" onClick={() => navigate('/')} style={{ display: 'inline-flex', alignItems: 'center', gap: 6, padding: '8px 12px', borderRadius: 8, border: '1px solid #1E293B', background: '#141820', color: '#E2E8F0', fontSize: 14, fontWeight: 600, cursor: 'pointer' }}>
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 40, gap: 16, textAlign: 'center' }}>
            <i className="ti ti-layout-grid" style={{ fontSize: 48, color: '#475569' }} />
            <div style={{ fontSize: 18, fontWeight: 700, color: '#E2E8F0' }}>Sector Map</div>
            ...
            <button
              ...
              style={{ padding: '10px 24px', borderRadius: 8, background: '#00C805', border: 'none', color: '#000', fontSize: 13, fontWeight: 700, cursor: 'pointer' }}
            >
              Sign in free →
            </button>
          </div>
