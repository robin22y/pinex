...
export default function AdminStockEdit() {
  ...
  async function generateDescription(model) {
    ...
    try {
      ...
      if (json?.description) {
        setCoForm((s) => ({ ...s, description: json.description.slice(0, 300) }))
                  ...
                  <div className="flex gap-1.5">
                    ...
                    >
                      {aiGenerating === 'claude' ? (
                        ...
                        <><i className="ti ti-sparkles" style={{ fontSize: 11 }} /> Claude</>
                      )}
                    </button>
                    <button
                      type="button"
                    ...
                    >
                      {aiGenerating === 'gemini' ? (
                        ...
                        <><i className="ti ti-sparkles" style={{ fontSize: 11 }} /> Gemini</>
                      )}
                    </button>
                  </div>
                </div>
