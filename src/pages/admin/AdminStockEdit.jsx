        ...
        <div className="space-y-4">
          ...
          <section className="rounded-lg border p-4" style={{ borderColor: BORDER, background: CARD }}>
            ...
            <div className="flex flex-col gap-2">
              ...
              <button
                type="button"
                disabled={busyAction === 'admin-generate-ai-description'}
                onClick={() => void runPipeline('admin-generate-ai-description')}
                className="rounded border px-3 py-2 text-left text-sm disabled:opacity-50"
                style={{ borderColor: BORDER, color: '#e2e8f0' }}
              >
                {busyAction === 'admin-generate-ai-description' ? 'Running…' : 'Re-generate AI description'}
              </button>
            </div>
          </section>
        </div>
